                            ...
                            <div id="login" class="tab-pane active text-center">
                                <form class="p-a30 dez-form p-b0 m-t100" id="userLoginForm">
                                    ...
                                    <div class="form-group search-input">
                                        <input name="userpassword" required="" class="form-control dz-password" placeholder="Type Password" type="password">
                                        <div class="show-pass">
    ...
    $(document).ready(function() {
        ...
        $("#userLoginForm").validate({
            ...
            submitHandler: function(form) {
                // Handle the form submission (for example, via AJAX)
                form.submit();
            }
        });

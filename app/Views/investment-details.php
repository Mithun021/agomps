            ...
            <div class="row col-set-block white-block m-lr0">
                <div class="col-lg-8">
                    ...
                    <div class="investment-details">
                        ...
                        <p class="card-text m-0 fw-bold"><i class="fa fa-bullhorn"></i> Expect Profit : <i class="fa fa-inr"></i><?= $investment['expected_profit'] ?></p>
                        ...
                        <form action="<?= base_url() ?>investment-details/<?= $investment_id ?>" method="post">
                            <input type="hidden" name="investment_amount" value="<?= $investment['min_amount'] ?>" readonly>

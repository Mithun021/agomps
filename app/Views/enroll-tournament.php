                                        ...
                                        <div class="row">
                                            ...
                                            <form id="teamRegisterationForm" method="post" action="<?= base_url() ?>enroll-tournament/<?= $tournament_id ?>" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <h3>Team Details<span class="text-danger">* Note :  कम से कम <?= $tournaments['min_players'] ?> प्रतिभागी का विवरण भरना अनिवार्य है। </span></h3>
                                            ...
                                            <?php if ($find_tournament_id) { if(empty($find_tournament_id['payment_status'])){ ?>

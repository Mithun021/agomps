                    ...
                    <div class="col-lg-3 col-sm-6 m-b30">
                        <div class="dez-box p-a10 border-1 bg-gray">
                            ...
                            <div class="price_details">
                                ...
                                <?php } ?>
                                <?php if ($tournaments) { ?><h5 class="text-primary text-center"><i class="fa fa-trophy"></i> Win : <i class="fa fa-rupee"></i> <?= $tournaments['first_rank_price'] ?></h5> <?php }else { echo "<h5 class='text-danger text-center'>Tournament not availbale</h5>"; } ?>
                            </div>
                        </div>
                    </div>
                <?php } ?>

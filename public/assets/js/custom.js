	...
	var dzTheme = function(){
		if(screenWidth < 991){
			if($('.mo-left .header-nav').children('div').length == 0){
				...
				jQuery('.mo-left .header-nav .logo-header > a > img').attr('src',base_url + 'public/assets/images/logo.png');
				jQuery('.mo-left.lw .header-nav .logo-header > a > img').attr('src',base_url + 'public/assets/images/logo-white.png');
			}
		}else{
